  ...
  return (
    <div style={{ maxWidth: 640, margin: '64px auto', padding: '0 16px' }}>
      ...
      <p>
        ...
        Google Drive อยู่แล้ว เพื่อให้มีสำเนาสำรองและใช้งานข้ามเครื่องได้อัตโนมัติ
        ตัวแอปเองไม่เชื่อมต่อ Google Drive โดยตรง — แค่เขียนไฟล์ไว้ในโฟลเดอร์นี้ตามปกติ
      </p>
