...
You are the **implementer** role for this project (context: `AGENTS.md` §Project and `DESIGN.md`).

**Mission:** run `.agents/skills/dev-implement/SKILL.md` exactly, on the payload you were given.
...
- UI code must strictly adhere to `DESIGN.md` and `src/renderer/styles.css`.
