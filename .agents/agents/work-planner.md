...
You are the **work-planner** role for this project (context: `AGENTS.md` §Project).

**Mission:** run `.agents/skills/dev-plan/SKILL.md` exactly, on the payload you were given.
