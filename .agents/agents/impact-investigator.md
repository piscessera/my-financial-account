...
You are the **impact-investigator** role for this project (context: `AGENTS.md` §Project).

**Mission:** run `.agents/skills/dev-investigate/SKILL.md` exactly, on the payload you were given.
